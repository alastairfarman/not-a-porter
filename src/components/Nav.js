...
export default function Nav(props) {
  ...
  function changePage(e){
    ...
    props.setCurrentPage(e.target.dataset.page)
  }
  ...
  return (
    <header>
      <div className="head">
        ...
        <div className="logo" data-page="home" onClick={changePage}>
          <svg
            ...
            data-page="home"
          >
            <g fill="none" fillRule="evenodd" data-page="home">
      ...
      <nav className="nav">
        <ul>
          ...
          <li>Shop By</li>
          <li>Designers</li>
          <li className="active" data-page="clothing" onClick={changePage}>Clothing</li>
          <li>Shoes</li>
          <li>Bags</li>
